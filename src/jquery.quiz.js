(function ($, window, document, undefined) {
  ...
  $.quiz = function (el, options) {
    ...
    base.methods = {
      init: function () {
        ...
        $(document).on('click', '.answers #b', function (e) {
          e.preventDefault();
      ...
      setup: function () {
        ...
        if (base.options.counter) {
          quizHtml += '<div id="quiz-counter" style="margin-top: 24px; margin-bottom: 8px; color:white;"></div>';
        }
        ...
        $.each(questions, function (i, question) {
          ...
          $.each(question.options, function (index, answer) {
           quizHtml += '<li><a href="#" id="b" class="a" data-index="' + index + '">' + answer + '</a></li>';
            //quizHtml += '<li><input type=radio href="#" data-index="' + index + '"  name="tip3" value="' + index + '">' + answer + '</li>';
          });
          quizHtml += '</ul>';
          quizHtml += '</div>';
        });
  ...
  $.quiz.defaultOptions = {
    ...
    resultsFormat1: '<br\>Congratulations!<br/>You have spotted all the differences<br/>correctly!<br\><span style="color:#000">&#9733;&#9733;&#9733;&#9733;&#9733;</span>',
    resultsFormat2: '<br\>Well played, missed by an inch!<br\><span style="color:#000">&#9733;&#9733;&#9733;</span><span style="color:#c5c5c5">&#9733;</span>',
    resultsFormat3: '<br\>Well done, smarty-pants!<br\><span style="color:#000">&#9733;&#9733;</span><span style="color:#c5c5c5">&#9733;&#9733;</span>',
    resultsFormat4: '<br\>Well played. But you can do better!<br\><span style="color:#000">&#9733;</span><span style="color:#c5c5c5">&#9733;&#9733;&#9733;&#9733;</span>',
    //resultsFormat5: '<br\>Hang in there, you will get better!<br\><span style="color:#000">&#9733;</span><span style="color:#c5c5c5">&#9733;&#9733;&#9733;&#9733;</span>',
    resultsFormat5: '<br\>Oops!<br/>You couldn\'t spot all the differences<br/>Better luck next time!',
